  ...
  if algo==1:
    ...
    if switch == 1:
      ...
      if switch2 == 1:
        ...
        print("\t\tIngrese la letra de mayor frecuencia en el idioma (inglés --> 'e')")
        freq=''
    ...
    if switch==1:
      ...
      if isbn==None:
        print("\t\tEl código no pudo ser arreglado o no corresponde al código de un libro.")
      else: print("\t\tEl código arreglado es:",isbn)

    elif switch==2:
      print(ISBN.titulo_ISBN(codigo))
    elif switch==3:
      print("El código "+codigo+(""if ISBN.es_ISBN(codigo) else " NO")+ " corresponde a un código ISBN")
